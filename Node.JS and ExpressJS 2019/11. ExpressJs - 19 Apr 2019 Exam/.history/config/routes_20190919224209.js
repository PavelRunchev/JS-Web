...
module.exports = app => {
    ...
    app.post('/course/course-addLecture/:id', controllers.course.courseAddLecturePost);

    app.get('/lecture/lecture-delete/:id', controllers.course.courseDeleteLecture);
    ...
    app.get('/lecture/lecture-video/:id', controllers.lecture.lectureVideo);
